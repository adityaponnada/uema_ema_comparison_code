...
difficult_burden <- c(paste0("phone_", difficult_burden), paste0("watch_", difficult_burden))
physical_burden <- c(paste0("phone_", physical_burden), paste0("watch_", physical_burden))
timesocial_burden <- c(paste0("phone_", timesocial_burden), paste0("watch_", timesocial_burden))
cognitive_burden <- c(paste0("phone_", cognitive_burden), paste0("watch_", cognitive_burden))
interruption_burden <- c(paste0("phone_", interruption_burden), paste0("watch_", interruption_burden))
...
final_burden_df$difficult_burden <- rowSums(final_burden_df[,difficult_burden], na.rm = TRUE)
final_burden_df$physical_burden <- rowSums(final_burden_df[,physical_burden], na.rm = TRUE)
final_burden_df$timesocial_burden <- rowSums(final_burden_df[,timesocial_burden], na.rm = TRUE)
final_burden_df$cognitive_burden <- rowSums(final_burden_df[,cognitive_burden], na.rm = TRUE)
final_burden_df$interruption_burden <- rowSums(final_burden_df[,interruption_burden], na.rm = TRUE)
