...
```{r}
describeBy(time_pid_df$uema_completion_rate, group = time_pid_df$participant_status)
describeBy(time_pid_df$uema_compliance_rate, group = time_pid_df$participant_status)

```

```{r}
describeBy(burst_pid_df$burst_completion_rate, group = burst_pid_df$participant_status)
describeBy(burst_pid_df$burst_compliance_rate, group = burst_pid_df$participant_status)
```
